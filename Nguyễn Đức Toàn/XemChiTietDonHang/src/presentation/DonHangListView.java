...
// Ten file   : DonHangListView.java
// Goi        : presentation (tang Presentation)
// Mo ta      : Lop bien (boundary) hien thi Man hinh 2 - Danh sach don hang
//              kem o tim kiem, bo loc, phan trang (muc 7.7 SRS) va trang thai
//              "khong tim thay" Man hinh 4 (muc 7.9 SRS).
//              Khop Bieu do lop thiet ke BT6.
// Phu thuoc  : businesslogic.DonHangController, businesslogic.ChiTietDonHangDTO,
//              businesslogic.DonHangDaHuyException, domainmodel.*, javax.swing
// ============================================================
...
/**
 * Man hinh danh sach don hang (Man hinh 2 + trang thai khong tim thay Man hinh 4).
 *
 * <p>Tuong ung class &lt;&lt;boundary&gt;&gt; DonHangListView trong Bieu do lop BT6:</p>
 * <ul>
 *   <li>hienThiDanhSachDonHang(dsDonHang: List): void</li>
 *   <li>hienThiKetQuaTimKiem(dsKetQua: List): void</li>
 *   <li>hienThiThongBao(msg: String): void</li>
 * </ul>
 */
public class DonHangListView extends JFrame {
    ...
    /** Nhan + ma trang thai cho bo loc (muc 7.7 SRS). */
    ...
    /** Nhan + ma phuong tien VT cho bo loc (muc 7.7 SRS). */
    ...
    /**
     * @param controller controller dieu phoi UC006 (cho phep inject de kiem thu)
     */
    public DonHangListView(DonHangController controller) {
        this.controller = controller;
        this.chiTietView = new ChiTietDonHangView(this);
    ...
    private JPanel taoTrungTam() {
        ...
        // Card trang thai rong (Man hinh 4 - muc 7.9 SRS)
    ...
    private JPanel taoChanTrang() {
        ...
        // Phan trang (muc 7.7 SRS). Bo du lieu mau nho nen hien 1 trang.
    ...
    // ====================================================================
    // CAC PHUONG THUC THEO BIEU DO LOP BT6
    // ====================================================================

    /**
     * Hien thi danh sach don hang len bang (luong chinh buoc 1-2).
     *
     * <p>Tuong ung hienThiDanhSachDonHang(dsDonHang: List): void.</p>
     *
     * @param dsDonHang danh sach don hang can hien thi
     */
    ...
    /**
     * Hien thi ket qua tim kiem (luong chinh buoc 5, luong thay the 5a).
     *
     * <p>Tuong ung hienThiKetQuaTimKiem(dsKetQua: List): void. Neu danh sach
     * rong -&gt; chuyen sang trang thai "khong tim thay" (Man hinh 4).</p>
     *
     * @param dsKetQua danh sach ket qua tim kiem
     */
     ...
     *
     * <p>Tuong ung hienThiThongBao(msg: String): void.</p>
     *
    ...
    /**
     * Xu ly khi nguoi dung chon mot don hang de xem chi tiet (buoc 6-8 / 7a).
     * Phan biet 3 ket qua tu controller: hop le -&gt; mo chi tiet;
     * null -&gt; thong bao khong tim thay; da huy -&gt; mo canh bao (Man hinh 5).
     */
    ...
    private JTable taoBangDonHang(DefaultTableModel model) {
        ...
        // Click cot "Thao tac" hoac double-click dong -> xem chi tiet (buoc 6 SRS)
